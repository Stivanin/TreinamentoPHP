        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Exercícios Extras <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="exercicio01/exercicio01.php">Exercício 1</a></li>
                            <li><a href="pets_new.php">Exercício 2</a></li>
                            <li><a href="exercicio03/exercicio03.php">Exercício 3</a></li>
                            <li><a href="exercicio04/exercicio04.php">Exercício 4</a></li>
